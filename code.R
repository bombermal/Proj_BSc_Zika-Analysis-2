# setwd("/home/dadamorais")
# path <- "./R/x86_64-redhat-linux-gnu-library/3.3"

# library(igraph, lib.loc = path)
# library(snow, lib.loc = path)
# library(data.table, lib.loc = path)
# library(parallel, lib.loc = path)

setwd("C:/Users/ivana/OneDrive/Aulas/Monitoria/Plano de trabalho 220917/Zika-Analysis-2/read")
